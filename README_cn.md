...
## 软件准备工作
 1.前往[息通开发平台](https://open.zhilianxi.com/front/#/login)注册账号，创建应用获取 APP 鉴权信息；<a href="https://open.zhilianxi.com/front/#/login" target="_blank" rel="noopener noreferrer">息通开发平台</a>
